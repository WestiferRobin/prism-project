...
def test_prism_labs(platform: PlatformType = PlatformType.Web, version: int = INITIAL_VERSION) -> None:
...
def test_prism_studio(platform: PlatformType = PlatformType.Web, version: int = INITIAL_VERSION) -> None:
...
def test_prism_tables(platform: PlatformType = PlatformType.Web, version: int = INITIAL_VERSION) -> None:
...
def test_prism_scribe(platform: PlatformType = PlatformType.Web, version: int = INITIAL_VERSION) -> None:
...
def test_prism_forge(platform: PlatformType = PlatformType.Web, version: int = INITIAL_VERSION) -> None:
...
def test_prism_hive(platform: PlatformType = PlatformType.Web, version: int = INITIAL_VERSION) -> None:
