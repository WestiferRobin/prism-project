...
def test_mobile_apps(version: int = LAMBDA_VERSION) -> None:
...
def test_bots(version: int = LAMBDA_VERSION) -> None:
...
def test_platform(version: int = LAMBDA_VERSION):
